...
router.post('/project/:projectId', validate(createTaskStatusSchema), asyncHandler(taskStatusController.create as any));
router.get('/project/:projectId', asyncHandler(taskStatusController.getAllByProject as any));

// Tekil kolon işlemleri
router.put('/:id', validate(updateTaskStatusSchema), asyncHandler(taskStatusController.update as any));
